...
const Templates: React.FC = () => {
  const items: Item[] = [
    { name: 'Item 1', description: 'This is the first item.', language: TemplateLanguage.LuaLaTex, favourite: false, lastModified: new Date('2024-08-03T19:00:00') },
    ...
    { name: 'Item 3', description: 'This is the second item.', language: TemplateLanguage.LuaLaTex, favourite: false, lastModified: new Date('2023-10-03T16:45:00') },
